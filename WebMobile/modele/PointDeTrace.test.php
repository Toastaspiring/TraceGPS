...
$uneVitesse = 0;
$unPoint1 = new PointDeTrace($unIdTrace, $uneTrace->getNombrePoints()+1, $latitude, $longitude, $altitude, $dateHeure, $rythmeCardio, $unTempsCumule, $uneDistanceCumulee, $uneVitesse);
