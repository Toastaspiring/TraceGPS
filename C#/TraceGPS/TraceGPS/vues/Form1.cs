...
namespace TraceGPS
{
    public partial class Form1 : Form
    {
        ...
        const String nomApplication = "Trace GPS 1.1";

        // pour gérer la trace
        Trace laTrace;
        Passerelle laPasserelle;		    // on déclare avec la classe abstraite
        ...
        private void btnOuvrir_Click(object sender, EventArgs e)
        {
            ...
            if (this.openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {   // si pas d'erreur
                    ...
                    // lissage de certaines données comme l'altitude
                    laTrace = laTrace.lisserDonnees();
                    ...
                    this.Text = nomApplication + " - " + nomCourt;
